...
<section class="max-w-7xl mx-auto px-6 py-4">
  ...
  <div id="panel-strategy" class="detail-panel mb-4">
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
      ...
      <p class="text-slate-400 mb-4"><span class="text-white font-semibold">The How</span> — AI analyzes the RFE, researches the codebase, consults our architectural context repository, and produces a comprehensive technical strategy. A Staff Engineer reviews the input and signs off on the RFE before it moves forward.</p>
