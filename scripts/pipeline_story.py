...
<section class="max-w-7xl mx-auto px-6 py-4">
  ...
  <div class="grid grid-cols-5 gap-3 mb-8">
    ...
    <div class="stage-card bg-slate-900 border-2 border-slate-700 rounded-xl p-4 text-center" onclick="toggleStage('rfe')" id="card-rfe">
      ...
      <div class="mt-2"><span class="inline-block w-2 h-2 rounded-full bg-emerald-500"></span></div>
    </div>
    ...
    <div class="stage-card bg-slate-900 border-2 border-slate-700 rounded-xl p-4 text-center" onclick="toggleStage('agentloop')" id="card-agentloop">
      ...
      <div class="mt-2"><span class="inline-block w-2 h-2 rounded-full bg-amber-500"></span></div>
    </div>
  ...
  <div id="panel-strategy" class="detail-panel mb-4">
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
      ...
      <p class="text-slate-400 mb-4">AI analyzes the RFE, researches the codebase, consults architecture docs, and produces a comprehensive technical strategy.</p>

      <div class="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 mb-6">
        <h4 class="text-sm font-semibold text-blue-400 mb-2">TL;DR</h4>
        <p class="text-slate-300 text-sm leading-relaxed">{md_inline_to_html(tldr)}</p>
      </div>

      <div class="grid md:grid-cols-2 gap-6">
        <div>
          <h4 class="text-sm font-semibold text-slate-300 mb-3 uppercase tracking-wider">Affected Components</h4>
          {components_table}

          <h4 class="text-sm font-semibold text-slate-300 mt-6 mb-3 uppercase tracking-wider">Impacted Teams</h4>
          {teams_table}
        </div>
        <div>
          {screenshot_slot("strategy", "Screenshot: Jira Strategy Ticket")}
        </div>
      </div>
    </div>
  </div>
