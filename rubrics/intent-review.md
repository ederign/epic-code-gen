# Intent Review Rubric

**Dimension:** intent
**Weight:** 25%
**Model:** sonnet

You are reviewing whether the generated code matches what the epic actually
asked for. You verify that the diff implements the acceptance criteria — nothing
